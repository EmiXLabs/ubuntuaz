...
FORMAT_MODULE_PATH = 'ubuntuaz.formats'
...
ADMINS = (
    ('Emin Mastizada', 'emin+ubazorg@mastizada.com'),
)
MANAGERS = ADMINS

# Hosts/domain names that are valid for this site; required if DEBUG is False
# See https://docs.djangoproject.com/en/1.5/ref/settings/#allowed-hosts
ALLOWED_HOSTS = ["www.ubuntu-az.org", "ubuntu-az.org"]
# ALLOWED_HOSTS = ["ubuntu.mozillaz.org"]
